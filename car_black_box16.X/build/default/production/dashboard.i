...
void view_dashboard() {
    ...
    if (key == 1) {
        ...
        clcd_print("  TIME  GEAR  SD", (0x80 + (0)));
...
void display_main_menu() {
    ...
    if (select_index == 1) {
        clcd_putch('*', (0x80 + (0)));
        clcd_putch(' ', (0xC0 + (0)));
        clcd_print(menu[menu_index], (0x80 + (3)));
        clcd_print(menu[menu_index + 1], (0xC0 + (3)));
    } else {

        clcd_putch('*', (0xC0 + (0)));
        clcd_putch(' ', (0x80 + (0)));

        clcd_print(menu[menu_index - 1], (0x80 + (3)));
        clcd_print(menu[menu_index ], (0xC0 + (3)));
    }
    if (key == 11) {
        clcd_write(0x01, 0);
        if (menu_index == 0) {
...
void download_log() {
    ...
    if (event_count > 0) {
        ...
        clcd_print("THROUGH UART", (0xC0 + (2)));
...
void set_time(void) {
    ...
    if (field == 0) {
        ...
        clcd_putch(':', (0xC0 + (2)));
        clcd_putch(':', (0xC0 + (5)));
        clcd_putch((minute / 10) + '0', (0xC0 + (3)));
        clcd_putch((minute % 10) + '0', (0xC0 + (4)));
        clcd_putch((second / 10) + '0', (0xC0 + (6)));
        clcd_putch((second % 10) + '0', (0xC0 + (7)));
